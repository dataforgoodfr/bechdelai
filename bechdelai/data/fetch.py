...
def fetch_data_from_url(url: str) -> requests.Response:
...
def fetch_image_from_url(url: str) -> Image:
    ...
    This function sends an HTTP GET request to the given URL, receives the image file as a binary
    response, and opens it as a PIL Image using BytesIO.

    Args:
        url (str): The URL of the image to fetch.

    Returns:
        PIL.Image: The fetched image as a PIL Image object.
    """
